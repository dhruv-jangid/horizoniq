import { Location01Icon, MapsSearchIcon } from "@hugeicons/core-free-icons";
...
function PlaceAutocomplete({
  ...
  return (
    <Command className={cn("h-fit overflow-visible p-0", className)} shouldFilter={false} loop>
      <div className="relative">
        <InputGroup
          className={cn(
            "border-black/50! bg-popover! ring-0! h-10 gap-0.5 px-1",
            showCommandList && "rounded-t-xl rounded-b-none",
          )}
        >
          <InputGroupAddon>
        ...
        {showCommandList && (
          <CommandList
            ...
            className={cn(
              "bg-popover border-black/50 absolute top-full right-0 left-0 rounded-b-xl border border-t-0 shadow-md",
                ...
                {results.map((feature) => {
                  ...
                  return (
                    <CommandItem
                      ...
                      className="gap-3.5 cursor-pointer"
                    >
